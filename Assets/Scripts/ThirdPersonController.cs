...
public class ThirdPersonController : MonoBehaviour
{
    ...
    [SerializeField] private float jumpDowntime = 1f;
    ...
    // --- NEW: Reset values when script is disabled to prevent "weird" movement ---
    private void OnDisable()
    {
        move = Vector2.zero;
        look = Vector2.zero;
        if (body != null) body.linearVelocity = new Vector3(0, body.linearVelocity.y, 0);
        if (animator != null) animator.SetFloat(speedParamName, 0);
    }
